...
Se você quiser, posso **fazer agora um wireframe visual completo do AuthLayout**, mostrando **login, cadastro e reset de senha**, com cores, botões, animações e posições sugeridas, pronto para passar para shadcn/ui + Tailwind.
